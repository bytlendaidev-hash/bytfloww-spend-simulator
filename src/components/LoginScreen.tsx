  ...
  return (
    <div className="min-h-[82vh] flex flex-col items-center justify-center px-4 py-8 sm:py-12 animate-emergence">
      <div className="spatial-card w-full max-w-md p-8 sm:p-10 text-center space-y-6 shadow-2xl relative overflow-hidden">
        {/* Top ambient glow */}
        <div className="absolute -top-20 left-1/2 -translate-x-1/2 w-56 h-56 rounded-full bg-emerald-500/15 blur-3xl pointer-events-none" />

        {/* Brand Icon Badge */}
        <div className="flex justify-center relative z-10">
          <BytLendLogo size="lg" isDark={isDark} />
        </div>

        <div className="space-y-1 relative z-10">
          <h1 className="text-2xl sm:text-3xl font-extrabold tracking-tight text-abyss-textPrimary flex items-center justify-center font-fraunces">
            Byt<span className="text-[#00884E] dark:text-[#1AE893] ml-0.5">Floww</span>
          </h1>
          <p className="text-xs text-[#00884E] dark:text-[#1AE893] font-bold uppercase tracking-widest">
            Autonomous AI Capital Forensics
          </p>
          <p className="text-[11px] text-abyss-textMuted pt-0.5">
            BytLend VisionOS Design System
          </p>
        </div>
        ...
        <div className="p-3 rounded-2xl bg-abyss-well border border-abyss-border space-y-2">
          <div className="flex items-center justify-between text-[10px] uppercase font-bold text-abyss-textMuted px-1">
            ...
            <span className="text-[#00884E] dark:text-[#1AE893]">{THEME_TEMPLATES[activeTheme]?.name}</span>
          </div>
          ...
          <form onSubmit={handleEmailLogin} className="space-y-4 text-left">
            <div>
              ...
              <input
                ...
                className="w-full px-4 py-3 rounded-xl bg-abyss-well border border-abyss-border text-sm text-abyss-textPrimary placeholder-abyss-textMuted outline-none focus:border-emerald-500"
              />
            </div>
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full py-3 rounded-2xl btn-emerald-capsule text-white text-xs font-bold transition flex items-center justify-center gap-2 shadow-sm"
            >
                ...
                <div>
                  ...
                  <div className="flex gap-2">
                    ...
                    <input
                      ...
                      className="flex-1 px-4 py-3 rounded-xl bg-abyss-well border border-abyss-border text-sm text-abyss-textPrimary placeholder-abyss-textMuted outline-none focus:border-emerald-500 font-mono"
                    />
                  </div>
                </div>
              ...
              <form onSubmit={handleVerifyOtp} className="space-y-4">
                <div>
                  ...
                  <input
                    ...
                    placeholder="123456"
                    className="w-full px-4 py-3 rounded-xl bg-abyss-well border border-abyss-border text-center text-lg font-mono tracking-widest text-abyss-textPrimary placeholder-abyss-textMuted outline-none focus:border-emerald-500"
                  />
                </div>
